// src/main.js
/**
 * Main entry point for ProCryptoGateway application
 */
...
class ProCryptoGateway {
    /**
     * Create a new ProCryptoGateway instance
...
module.exports = ProCryptoGateway;
...
if (require.main === module) {
    ...
    const app = new ProCryptoGateway({
        input: args.input,
        output: args.output,
